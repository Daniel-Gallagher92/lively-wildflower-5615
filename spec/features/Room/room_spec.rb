...
RSpec.describe 'Room Index', type: :feature do 
  before :each do
    ...
    @hotel2 = Hotel.create!(name: "Echo Other Mountain Inn", location: "Echo Mountain")
    ...
    @room_3 = @hotel2.rooms.create!(rate: 50, suite: "Honeymoon Suite")
  ...
  it 'displays all rooms and their attributes' do 
    ...
    expect(page).to have_content("Echo Other Mountain Inn")
